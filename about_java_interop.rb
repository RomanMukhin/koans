...
class AboutJavaInterop < EdgeCase::Koan
  def test_using_a_java_library_class
    ...
    assert_equal JavaArray, java_array.class
  end
  ...
  def test_some_ruby_objects_can_be_coerced_to_java
    assert_equal "ruby string", "ruby string".to_java.class
    assert_equal 1, 1.to_java.class
    assert_equal 9.32, 9.32.to_java.class
    assert_equal false, false.to_java.class
  end
